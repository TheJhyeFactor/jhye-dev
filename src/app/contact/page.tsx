    ...
    <div className="page-shell">
      <section className="grid min-h-[calc(100vh-77px)] gap-12 py-20 md:grid-cols-[1.2fr_0.6fr] md:items-end md:py-28">
        <div>
          ...
          <TrackedEmailLink href={`mailto:${profile.email}?subject=Portfolio%20conversation`} className="button-primary mt-9" location="contact_page">
        ...
        <aside className="border-t border-[var(--ink)] pt-5">
          ...
          <p className="mt-8 text-sm leading-6 text-[var(--muted)]">Based in Tokyo, working with people and teams across time zones. Open to product engineering roles and thoughtful software work.</p>
        </aside>
      </section>
    </div>
  )
