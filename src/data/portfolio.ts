...
export const openSourceProjects = [
  { title: 'CareerLift', type: 'Public tool', description: 'An ATS-aware resume builder that keeps document processing in the browser.', href: 'https://thejhyefactor.github.io/careerlift/', repo: 'https://github.com/TheJhyeFactor/careerlift', note: 'A practical test of private, client-side document workflows.' },
  { title: 'Browser OS', type: 'Open experiment', description: 'A browser desktop with draggable windows, a terminal, and local persistence.', href: 'https://thejhyefactor.github.io/browser-os/', repo: 'https://github.com/TheJhyeFactor/browser-os', note: 'An exploration of familiar desktop metaphors in browser tools.' },
  { title: 'PDF Tools', type: 'Public tool', description: 'Client-side utilities for merging, splitting, compressing, and converting PDFs.', href: 'https://thejhyefactor.github.io/pdf-tools/', repo: 'https://github.com/TheJhyeFactor/pdf-tools', note: 'A small utility focused on useful defaults and local processing.' },
  { title: 'Object Detection', type: 'Open experiment', description: 'A browser computer-vision experiment using TensorFlow.js.', href: 'https://thejhyefactor.github.io/object-detection/', repo: 'https://github.com/TheJhyeFactor/object-detection', note: 'A hands-on investigation into computer vision without a server round trip.' },
]
